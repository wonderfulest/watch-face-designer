  ...
  <div class="settings-section">
    ...
    <div class="setting-item">
      ...
      <div class="align-buttons">
        <button v-for="align in LayoutOptions" :key="align.value" @click="updateLayout(align.value)" :class="{ active: originY === align.value }" :title="align.label">
    ...
    <div class="setting-item">
      <label>图标颜色</label>
      <ColorPicker v-model="iconColor" @change="updateIconColor" />
    </div>
